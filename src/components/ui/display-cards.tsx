...
function DisplayCards({ cards }: DisplayCardsProps) {
  const defaultCards: DisplayCardProps[] = [
    {
      icon: <BookOpen className="size-4 text-[var(--gold)]" />,
      title: "Personalized PR & Branding",
      description: "Build your author identity & reach",
      date: "Value Pillar",
      titleClassName: "text-[var(--gold)]",
      className:
    ...
    {
      icon: <Feather className="size-4 text-[var(--gold)]" />,
      title: "Editorial Care",
      description: "Your voice, perfected",
      date: "Value Pillar",
      titleClassName: "text-[var(--gold)]",
      className:
    ...
    {
      icon: <Sparkles className="size-4 text-[var(--gold)]" />,
      title: "From Writer to Reader",
      description: "You write it. People read it.",
      date: "Value Pillar",
      titleClassName: "text-[var(--gold)]",
      className:
